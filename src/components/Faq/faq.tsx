    ...
    const questionsAnswers = [
        {
            ...
            answer:
                `Version Beta is a technical conclave comprising of the following events : 
        ...
        },
        {
            ...
            answer:
                `Under Version Beta, workshops on Data Science and Data Structures & Algorithms will be conducted. The workshops will be mentored by Prateek Narang from Coding Blocks.`,
        },
        {
